...
<body>
  <div class="container">
    <header>
      ...
      <div class="sub">Please complete all relevant sections. Leave fields blank if unknown.</div>
    </header>
	<c:if test="${not empty requestScope.message}">
    	<div class="alert alert-success">${requestScope.message}</div>
	</c:if>
    <form aria-label="Psychological Case Record" action="handleAddPatient" method="post">
      <fieldset>
        <div class="grid">
          <div class="col-6">
          ...
          <div class="col-6">
            ...
            <input id="age" name="age" type="number" min="0" inputmode="numeric" />
          </div>
        </div>
      </fieldset>
      ...
      <fieldset>
        ...
        <div class="grid">
          <div class="col-4">
            ...
            <input id="clientmobile" name="clientmobile" type="tel" inputmode="tel" />
          </div>
          <div class="col-4">
          ...
          <div class="col-6">
            ...
            <input id="email1" name="email1" type="email" autocomplete="email" />
          </div>
          <div class="col-6">
      ...
      <fieldset>
       <div class="grid"> 
            <div class="col-12">
          	...
          	<div class="col-6">
	            <label>1.4 Onset:</label>
	        </div>
	             <input type="checkbox" name="patientsDetails1.onset" value="Acute">Acute
	             <input type="checkbox" name="patientsDetails1.onset" value="Insidious">Insidious
      		<div class="col-12">
        ...
        <div class="grid">   	
          	...
          	<div class="col-3">
	            <label for="patientsDetails2.dress"> Dress: </label>
	             ...
	             <input type="checkbox" name="patientsDetails2.dress" value="Appropriate" style="white-space: nowrap;"> Appropriate
				 <input type="checkbox" name="patientsDetails2.dress" value="Inappropriate" style="white-space: nowrap;"> Inappropriate 
          	</div>
          	<div class="grid"> 
          	<div class="col-3" style="white-space: nowrap;">
			...
			<div class="grid">
			<div class="col-12">
	            <label>Age-appropriateness:  piercingAppears stated age or not  </label>
			</div>
			</div>
			<div class="grid">
			<div class="col-3" style="white-space: nowrap;">
	            <label for="patientsDetails2.notablephysicalfeatures">Notable physical features:  </label>
				  ...
				  <div><input type="checkbox" name="patientsDetails2.notablephysicalfeatures" value="signs of self-harm"> signs of self-harm </div>
			...
			<div class="col-3" style="white-space: nowrap;">
				...
				<div><input type="checkbox" name="patientsDetails2.quantity" value="Tempo (high/moderate/low)"> Tempo (high/moderate/low)</div>
				<div><input type="checkbox" name="patientsDetails2.quantity" value="Volume (high/moderate/ low)"> Volume (high/moderate/ low)</div>
			...
			<div class="col-3" style="white-space: nowrap;">
				...
				<div><input type="checkbox" name="patientsDetails2.formandstructure" value="Aphasia (receptive/intermediate/expressive)"> Aphasia (receptive/intermediate/expressive)</div>
			...
			<div class="col-3" style="white-space: nowrap;">
				...
				<div><input type="checkbox" name="patientsDetails2.mood" value="Anxious"> Thught echo </div>
				...
				<div><input type="checkbox" name="patientsDetails2.mood" value="DysphoriaLability"> DysphoriaLability</div>
			</div>
			</div>
			<div class="grid">
			<div class="col-3" style="white-space: nowrap;">
			...
			<div class="col-3" style="white-space: nowrap;">
				...
				<div>Time  :<input type="checkbox" name="patientsDetails2.time" value="Intact">Intact 
						<input type="checkbox" name="patientsDetails2.time" value="Impaired">Impaired</div>
				<div>Place :<input type="checkbox" name="patientsDetails2.place" value="Intact">Intact
						<input type="checkbox" name="patientsDetails2.place" value="Impaired">Impaired</div>
				<div>Person:<input type="checkbox" name="patientsDetails2.person" value="Intact">Intact
						<input type="checkbox" name="patientsDetails2.person" value="Impaired">	Impaired</div>
			</div>
			</div>
			<div class="grid">
			<div class="col-3" style="white-space: nowrap;">
			...
			<div class="col-3" style="white-space: nowrap;">
				<label>Memory: </label>
				<div>Immediate:<input type="checkbox" name="patientsDetails2.immediate" value="Intact">Intact 
						   <input type="checkbox" name="patientsDetails2.immediate" value="Impaired">Impaired</div>
				<div>Recent:<input type="checkbox" name="patientsDetails2.recent" value="Intact">Intact 
						   <input type="checkbox" name="patientsDetails2.recent" value="Impaired">Impaired</div>
				<div>Remote:<input type="checkbox" name="patientsDetails2.remote" value="Intact">Intact 
						   <input type="checkbox" name="patientsDetails2.remote" value="Impaired">Impaired</div>
				<div>Amnesia:<input type="checkbox" name="patientsDetails2.amnesia" value="Anterograde" style="white-space: nowrap;">Anterograde 
						   <input type="checkbox" name="patientsDetails2.amnesia" value="Retrograde">Retrograde</div>
			</div>
			</div>
			<div class="grid">
			<div class="col-3" style="white-space: nowrap;">
			...
			<div class="col-3" style="white-space: nowrap;">
				...
				<div>Personal: <input type="checkbox" name="patientsDetails2.judgementpersonal" value="Intact">Intact
				       	  <input type="checkbox" name="patientsDetails2.judgementpersonal" value="Impaired">Impaired  </div>
				<div>Social:	  <input type="checkbox" name="patientsDetails2.judgementsocial" value="Intact">Intact
						  <input type="checkbox" name="patientsDetails2.judgementsocial" value="Impaired">Impaired </div>
				<div>Test:	&nbsp;  <input type="checkbox" name="patientsDetails2.judgementtest" value="Intact">Intact
				    	  <input type="checkbox" name="patientsDetails2.judgementtest" value="Impaired">Impaired </div>
			</div>
			</div>
			<div class="grid">
			<div class="col-3" style="white-space: nowrap;">
				...
				<table>
				 <tr>
					<td><input type="checkbox" name="patientsDetails2.insight" value="Level 1. Complete denial of illness
								...
								style="width: 50px;"></td>
					<td style="width: 750px;">•	Level 1. Complete denial of illness <br/>
				...
				<tr>
					<td><input type="checkbox" name="patientsDetails2.insight" value="Level 2. Slight awareness of being sick and needing help, but denying it at the same time
							...
							style="width: 50px;"></td>
					<td style="width: 750px;">•	Level 2. Slight awareness of being sick and needing help, but denying it at the same time
				...
				<tr>
					<td><input type="checkbox" name="patientsDetails2.insight" value="Level 3. Awareness of being sick but blaming it on external factors
							...
							style="width: 50px;"></td>
					<td style="width: 750px;">•	Level 3. Awareness of being sick but blaming it on external factors
				...
				<tr>
					<td><input type="checkbox" name="patientsDetails2.insight" value="Level 4. Awareness that illness is due to something unknown in oneself
							...
							style="width: 50px;"></td>
					<td style="width: 750px;">•	Level 4. Awareness that illness is due to something unknown in oneself
				...
				<tr>
					<td><input type="checkbox" name="patientsDetails2.insight" value="Level 5. Intellectual insight
							...
							style="width: 50px;"></td>
					<td style="width: 750px;">•	Level 5. Intellectual insight
				...
				<tr>
					...
					<td style="width: 750px;">•	Level 6. True emotional insight
			...
			<div class="col-12">
				...
				<input type="text" id="patientsDetails2.otherobservations" name="patientsDetails2.otherobservations">
			</div>
			<div class="col-12">
				<label for="patientsDetails2.provisionalDiagnosis">9.   Diagnosis: </label>
				<input type="text" id="patientsDetails2.provisionalDiagnosis" name="patientsDetails2.provisionalDiagnosis">
			</div> 
			<div class="col-12">
				<label for="patientsDetails2.psychologicalassessmentconducted">10. Psychological assessment Conducted:</label>
				<input type="text" id="patientsDetails2.psychologicalassessmentconducted" name="patientsDetails2.psychologicalassessmentconducted">
			</div>
			<div class="col-12">
				<label for="patientsDetails2.psychologicalreport">11. Psychological Report:</label>
				<input type="text" id="patientsDetails2.psychologicalreport" name="patientsDetails2.psychologicalreport">
			</div>
			<div class="col-12">
				<label for="patientsDetails2.managementplan">12. Management Plan:</label>
				<input type="text" id="patientsDetails2.managementplan" name="patientsDetails2.managementplan">
			</div> 
			</div>
      </fieldset>
           <div class="actions">
       		<a href="homePage" class="btn-primary"> HOME </a>
